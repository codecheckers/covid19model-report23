...
expected, and all key datasets were provided.  I was able to regenrate
...
the states have been re-ordered vertical in order of the the value of
...
<https://github.com/ImperialCollegeLondon/covid19model> was cloned, and renamed to
"sje30/covid19model-report23".  (I could not clone the project into
the Github codecheckers group, as you cannot have two forks of the same project
in the same organistion.)

This reproduction was performed after finishing the related
certificate [2020-010](https://doi.org/10.5281/zenodo.3893138);
...
version of rstan package; this was upgraded to 2.19.3.  The
simulations were tested by running the simulation directly on a
workstation:
...
```
The final run time was 1020 minutes (17 hours).  The code for
reproducing figures 1,2 and 3 was not available in the repository, but
all other key figures could be regenerated.
